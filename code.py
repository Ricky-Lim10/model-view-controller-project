...
model=LogisticRegression(solver= "saga",multi_class='multinomial').fit(xtrainscale,y_train)
...
def getpridiction(image):
    ...
    #what is clf library? It did not come up in the model view controller class code or the alphabet recognition project
